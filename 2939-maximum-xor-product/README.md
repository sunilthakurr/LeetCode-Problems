<h2><a href="https://leetcode.com/problems/maximum-xor-product">3192. Maximum Xor Product</a></h2><h3>Medium</h3><hr><p>Given three integers <code>a</code>, <code>b</code>, and <code>n</code>, return <em>the <strong>maximum value</strong> of</em> <code>(a XOR x) * (b XOR x)</code> <em>where</em> <code>0 &lt;= x &lt; 2<sup>n</sup></code>.</p>
